...
public class ShopkeeperSorter {
    ...
    public static List<Shopkeeper> getAllAdminShopkeepers(){
        ...
        for(Shopkeeper s :SKShopkeepersPlugin.getInstance().getShopkeeperRegistry().getAllShopkeepers()){
    ...
    public static void updateSellingItemStacks(Player p){
        for (Shopkeeper s : SKShopkeepersPlugin.getInstance().getShopkeeperRegistry().getAllPlayerShopkeepers()) {
...
//            ItemStack stack = InvUtils.customPlayerHead(Main.getInstance().keeperHeads.get(0), finalizedLore, (keeper.getName().equals(""))?"Shopkeeper": keeper.getName());
...
//            stacks.add(stack);
//            Collections.shuffle(Main.getInstance().keeperHeads);
//        }
//        return stacks;
    }
...
//        return stacks;
    ...
    public static List<String> getAllShopOwners(){
        ...
        for(PlayerShopkeeper s :SKShopkeepersPlugin.getInstance().getShopkeeperRegistry().getAllPlayerShopkeepers()){
    ...
    public static List<ItemStack> getSortedVisualsOfStringList(List<String> StringList){
        ...
        for(String s : StringList){
            items.add(InvUtils.customPlayerHead(Main.getInstance().keeperHeads.get(0),null, s));
            Collections.shuffle(Main.getInstance().keeperHeads);
        }
        return items;
    }
